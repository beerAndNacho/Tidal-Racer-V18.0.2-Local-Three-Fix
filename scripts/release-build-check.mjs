...
add('commercial blockers preserve structured evidence',source.includes("typeof evidence==='string'?evidence:JSON.stringify(evidence)"));
...
add('signed playtest protocol ships with package',source.includes('docs/PLAYTEST_PROTOCOL.md'));
