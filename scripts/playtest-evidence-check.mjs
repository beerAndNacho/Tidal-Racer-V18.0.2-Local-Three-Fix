...
add('audit enforces version and duration',audit.includes('version>=minimum')&&audit.includes('session.durationMinutes>=30'));
add('audit enforces crash and p95 limits',audit.includes('session.crashes===0')&&audit.includes('session.p95FrameMs<=40'));
