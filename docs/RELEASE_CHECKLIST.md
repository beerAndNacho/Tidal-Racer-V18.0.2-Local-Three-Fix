...
- In Golden Marina Free Roam, verify the Harbor Watch grace period, advisory, repeated-violation intercept, two-craft port-hold formation, reduced-effects searchlight treatment, four-second heave-to, insufficient-funds response, notice settlement, clean-operation reward, save/load persistence, and race/rescue exemptions.
